...
**สถานะ sync (BN, ก.ค. 2026):**
- [x] `BACKEND_TASKS.md` — M3/M4 mark ตามโค้ดจริง, เหลือ B1–B4
- [x] `docs/index.md` + `docs/backend_*.md` — อัปเดต API inventory, M3/M4 status, โมดูลใหม่ `backend_m3_chat.md`, `backend_m4_payment.md`
- [ ] `FRONTEND_TASKS.md` — mark M3 UI ที่เสร็จเป็น `[x]`, เหลือ F1–F4 (ฝั่ง FN)
- [ ] `PROJECT_STRUCTURE.md` — footer อัปเป็นสถานะปัจจุบัน

...
export const CATEGORY_INTRO_FOCUS: Record<string, string[]> = {
  ตัวตน: [
    "วิเคราะห์อุปนิสัยแก่นแท้ จุดแข็งและจุดอ่อนที่ซ่อนอยู่",
    "วิเคราะห์ระดับวาสนาบารมีและภาพรวมความสำเร็จในชีวิต",
    "วิเคราะห์ดาวที่กุมลัคนา ส่งเกณฑ์ถึงลัคนา และมุมสัมพันธ์ที่ถึงลัคนา",
  ],
  การงาน: [
    "วิเคราะห์รูปแบบอาชีพที่เหมาะสม ถูกโฉลก และสร้างความเจริญรุ่งเรือง",
    "วิเคราะห์สไตล์การทำงาน อุปสรรคที่มักพบ และวิธีปรับตัว",
    "วิเคราะห์โอกาสความก้าวหน้าและการสนับสนุนจากผู้ใหญ่",
  ],
  การเงิน: [
    "วิเคราะห์ศักยภาพการหาเงิน สภาพคล่อง และระดับฐานะทางการเงิน",
    "วิเคราะห์แหล่งทรัพย์สินหลัก เช่น น้ำพักน้ำแรง มรดก คู่ครอง หรือโชคลาภ",
    "วิเคราะห์จุดรั่วไหลทางการเงินและข้อควรระวัง",
  ],
  ความรัก: [
    "วิเคราะห์ลักษณะคู่ครองที่ถูกโฉลกและลักษณะการพบเจอจากพื้นดวง",
    "วิเคราะห์รูปแบบความสัมพันธ์และการอุปถัมภ์ระหว่างกัน",
    "วิเคราะห์จุดเปราะบางหรือบทเรียนในความรัก พร้อมแนวทางปรับตัวตามความเชื่อ",
  ],
  สุขภาพ: [
    "วิเคราะห์แนวโน้มด้านร่างกายหรืออวัยวะที่ควรใส่ใจ โดยไม่วินิจฉัยโรค",
    "วิเคราะห์ปัจจัยเสี่ยงตามพื้นดวงอย่างระมัดระวัง พร้อมแนวทางป้องกัน",
    "วิเคราะห์วิธีดูแลสุขภาพกายและใจที่เหมาะกับพื้นดวง",
  ],
  โชคลาภ: [
    "วิเคราะห์รูปแบบและโอกาสรับโชคลาภ การลงทุน และโอกาสดีในชีวิตจากพื้นดวง",
    "วิเคราะห์แนวทางลงมือทำเพื่อเพิ่มโอกาสและปลดล็อกความสำเร็จ โดยไม่รับประกันผล",
  ],
};

export function buildCategoryIntroQuestion(categoryName: string): string {
  const focus = CATEGORY_INTRO_FOCUS[categoryName] ?? [
    `วิเคราะห์ภาพรวมพื้นดวงด้าน${categoryName} จุดเด่น จุดที่ควรระวัง และแนวทางปรับตัว`,
  ];
  return [
    CATEGORY_INTRO_PREFIX,
    `สรุปพื้นดวงหมวด「${categoryName}」ให้ผู้ใช้ทันทีจาก [natal] [memory] [aspects] [intake] และทักษากำเนิด`,
    "ประเด็นที่ต้องวิเคราะห์:",
    ...focus.map((item) => `- ${item}`),
    "ทุกข้อให้เชื่อมคำอธิบายกับดาว ราศี ภพเรือน มาตรฐาน มุมสัมพันธ์ หรือทักษากำเนิดที่มีอยู่จริงในข้อมูล",
    "คำถามนี้เป็นพื้นดวงเดิม ห้ามนำดวงจรหรือคำตอบเก่ามาสร้างข้อเท็จจริง และไม่ต้องรอคำถามเพิ่ม",
    "ปิดท้ายสั้น ๆ ว่าถามต่อในแชทนี้ได้เลย",
    "ห้ามบอกให้ไปเปิดหมวดอื่นหรือเริ่มดวงจรใหม่",
  ].join("\n");
}

export const CATEGORY_INTRO_SYSTEM_HINT =
  "งานครั้งนี้คือบทสรุปหมวดทันทีจากพื้นดวง ตารางดาว มุมสัมพันธ์ ทักษากำเนิด และแบบสำรวจ ไม่ใช่การตอบคำถามแชท " +
  "วิเคราะห์ทุกประเด็นที่ระบุในคำถามและผูกเหตุผลกับข้อมูลดวงที่มีจริง " +
  "อย่าบอกให้ไปเปิดหมวดอื่นหรือเริ่มดวงจร ปิดท้ายว่าถามต่อในแชทนี้ได้เลย";

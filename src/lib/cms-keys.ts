...
export const CMS_DEFAULTS: Record<CmsKey, unknown> = {
    ...
    sections: [
      {
        ...
        body: [
          ...
          "ข้อมูลการใช้งาน: ประวัติการสนทนากับ AI หมวดที่เลือก และการทำรายการ usage/แพ็กเกจ",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "ลบบัญชีได้ด้วยตนเองที่หน้า /account (ยืนยันด้วยการพิมพ์อีเมล) — การลบจะลบโปรไฟล์ วันเกิด บทสนทนา usage และสลิปที่เกี่ยวข้องถาวร ไม่สามารถกู้คืนได้",
          "บันทึกการทำงานของแอดมิน (audit) อาจเก็บอีเมล/บทบาทของบัญชีที่ถูกลบเพื่อความปลอดภัยของระบบ โดยไม่มีวันเกิดหรือเนื้อหาแชท",
        ],
      },
      {
        ...
        body: [
          ...
          "รูปสลิปโอนเงินเก็บแบบ private และลบออกจากที่เก็บไฟล์ภายใน 90 วันหลังแอดมินตรวจจบ (อนุมัติหรือปฏิเสธ) — แถวประวัติการชำระอาจยังอยู่โดยไม่มีไฟล์สลิป",
        ],
      },
      {
  ...
  [CMS_KEYS.termsOfService]: {
    ...
    sections: [
      ...
      {
        heading: "5. การชำระเงินและ usage",
        body: [
          "การซื้อแพ็กเกจและ usage เพิ่มเป็นการซื้อครั้งเดียวและไม่สามารถขอคืนเงินได้ ยกเว้นกรณีที่ระบบมีข้อผิดพลาดที่ทำให้ไม่สามารถใช้บริการได้",
          "usage ที่มากับแพ็กเกจเริ่มใหม่เมื่อเข้าสู่รอบแพ็กเกจถัดไป ส่วน usage ที่เติมเพิ่มจะแยกเก็บและไม่หายเมื่อต่ออายุ",
        ],
      },
      {
        ...
        body: [
          ...
          "หากต้องการลบบัญชี ให้ไปที่หน้า /account แล้วใช้ส่วน「ลบบัญชี」— การลบบัญชีจะเป็นการลบข้อมูลถาวรและไม่สามารถกู้คืนได้",
        ],
      },
      {
  ...
  [CMS_KEYS.seoFaq]: {
    ...
    description: "คำตอบเกี่ยวกับ usage แพ็กเกจ Pro การชำระเงิน และการใช้งาน",
  } satisfies CmsSeo,
  [CMS_KEYS.seoPricing]: {
  ...
  [CMS_KEYS.landingHero]: {
    eyebrow: "ดูดวงตามหลักโหราศาสตร์ไทย",
    headline: "อ่านพื้นดวงจริงจากวันเกิดของคุณ",
    subheadline:
      "ใส่วัน เวลา และสถานที่เกิด ระบบคำนวณลัคนา ตำแหน่งดาว และทักษาตามระบบสุริยยาตร์ แล้วให้ AI อธิบายจากดวงชุดเดียวกัน ถามต่อได้ทั้งเรื่องงาน ความรัก และการเงิน",
    primaryCta: { text: "เริ่มดูดวงฟรี", href: "/login?tab=register" },
  ...
  [CMS_KEYS.landingFeatures]: {
    title: "ต่างจากแอปดูดวงทั่วไปตรงไหน",
    subtitle: "ทุกคำตอบอ้างอิงดวงที่คำนวณจากวันเกิดของคุณ ไม่ใช่คำทำนายกลาง ๆ ตามราศี",
    items: [
      {
        icon: "✨",
        title: "คำนวณตามสูตรสุริยยาตร์",
        description:
          "ลัคนา ตำแหน่งดาว และทักษา คำนวณจากวัน เวลา และสถานที่เกิด ไม่ใช่แค่ราศีจากเดือนเกิด",
      },
      {
        icon: "💬",
        title: "ถามต่อได้เป็นบทสนทนา",
        description:
          "เลือกหมวดที่สนใจ เช่น การงาน ความรัก การเงิน แล้วถามลึกต่อจากคำตอบก่อนหน้าได้",
      },
      {
        icon: "🔒",
        title: "เห็นดวงชุดเดียวกับที่ AI ใช้",
        description:
          "เปิดดูภาพดวงจักรกำเนิด ตำแหน่งดาว และเรือน เพื่อตรวจสอบว่าคำตอบมาจากอะไร",
      },
      {
        icon: "📱",
        title: "ใช้แค่ข้อมูลเกิด และเก็บไว้ในบัญชีคุณ",
        description:
          "ไม่ต้องให้ข้อมูลอื่น บทสนทนาบันทึกไว้ให้กลับมาอ่านได้ทั้งบนมือถือและคอมพิวเตอร์",
      },
    ],
  } satisfies CmsLandingFeatures,
  [CMS_KEYS.landingHowItWorks]: {
    title: "เริ่มต้นใน 3 ขั้นตอน",
    subtitle: "ใช้เวลาไม่ถึงห้านาทีก่อนคำถามแรก",
    steps: [
      {
        title: "สมัครสมาชิก",
        description: "สร้างบัญชีด้วยอีเมลหรือ Google ไม่มีค่าใช้จ่าย",
      },
      {
        title: "กรอกข้อมูลเกิด",
        description: "วัน เวลา และสถานที่เกิด ระบบคำนวณพื้นดวงให้ทันที",
      },
      {
        title: "เลือกหมวดแล้วถาม",
        description: "เริ่มจากหมวดตัวตนหรือการงานได้ฟรี อัปเกรด Pro เมื่อต้องการครบทุกหมวด",
      },
    ],
  } satisfies CmsLandingHowItWorks,
  [CMS_KEYS.landingPricingSection]: {
    title: "เลือกแพ็กเกจ",
    subtitle: "เริ่มฟรี อัปเกรดเมื่อต้องการถามครบทุกหมวด",
    enabled: true,

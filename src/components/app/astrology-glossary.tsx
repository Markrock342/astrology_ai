...
const CORE_TERMS = [
  ...
  ["องศา", "ตำแหน่งของดาวในราศีหนึ่ง ๆ ราศีละ 30 องศา รวมวงละ 360 องศา"],
  ["กุม", "ดาวตั้งแต่ 2 ดวงอยู่ในราศีเดียวกัน (ภพ 1) มุม 0° จึงห่างกันไม่เกิน 30 องศา"],
  ["เล็ง", "ดาวอยู่ราศีตรงข้าม เป็นเรือนที่ 7 ของกันและกัน มุม 180 องศา"],
  ["ตรีโกณ", "ดาวอยู่ในเรือน 5 หรือ 9 ของกันและกัน มุม 120 องศา มักเป็นธาตุเดียวกัน"],
  ["จตุโกณ", "ดาวอยู่ในเรือน 4 หรือ 10 ของกันและกัน มุม 90 องศา จุดตั้งฉากที่กดดันให้ต้องลงมือ"],
] as const;

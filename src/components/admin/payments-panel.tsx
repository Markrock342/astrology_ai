  ...
  return (
    ...
    >
      <button
        ...
        type="button"
        onClick={onClose}
        className="absolute right-3 top-3 flex min-h-11 min-w-11 items-center justify-center rounded-xl bg-black/60 px-4 text-sm font-semibold text-white transition hover:bg-black/80"
      >
        ปิด
      </button>

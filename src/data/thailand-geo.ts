...
/** Complete amphoe/khet dataset for all 77 provinces (928 districts).
 * Source: thailand-geography-data (official รหัสไปรษณีย์ไทย mapping), เมือง* first.
 * Engine coords fall back to province default for districts without precise
 * lat/lon (resolvePlaceCoords) — the amphoe-level delta is astrologically nil. */

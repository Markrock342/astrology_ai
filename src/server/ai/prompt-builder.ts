...
export const ENGINE_CHART_RULE =
  ...
  "ถ้ามีบล็อก [transit] แปลว่าผู้ใช้อยู่ในโหมดดวงจรแล้ว ห้ามแนะนำให้เปิด เริ่ม หรือไปดูดวงจรซ้ำ ให้ตอบจากดวงจรที่แนบมาทันที " +
...
export const RESPONSE_LAYOUT_RULE =
  ...
  "เมื่อแนะนำให้ไปหมวดอื่น ให้ทำชื่อหมวดเป็นลิงก์ตัวหนา: ตัวตน=/dashboard?cat=self การงาน=/dashboard?cat=career การเงิน=/dashboard?cat=finance ความรัก=/dashboard?cat=love สุขภาพ=/dashboard?cat=health โชคลาภ=/dashboard?cat=fortune " +
